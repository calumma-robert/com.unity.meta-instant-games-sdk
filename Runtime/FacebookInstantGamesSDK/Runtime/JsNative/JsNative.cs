...
namespace JsNative
{
    public class JsNative
    {
        ...
        /// </summary>
        internal void RemoveReference() => JS_jsNative_removeReference(Uuid);
        ...
        internal string GetMemberString(string memberName) => _jsNativeLib.GetMemberString(Uuid, memberName);
        ...
        internal void SetMemberString(string memberName, string value) => _jsNativeLib.SetMemberString(Uuid, memberName, value);
        ...
        /// <param name="memberName">The name of the member to retrieve the string value for.</param>
        /// <returns>The string value of the specified member.</returns>
        internal string GetMemberJsonSerializable(string memberName)
        ...
        /// <param name="memberName">The name of the member to set.</param>
        /// <param name="value">The string value to set.</param>
        internal void SetMemberJsonSerializable(string memberName, string value)
        ...
        internal double GetMemberNumber(string memberName) => _jsNativeLib.GetMemberNumber(Uuid, memberName);
        ...
        internal void SetMemberNumber(string memberName, double value) => _jsNativeLib.SetMemberNumber(Uuid, memberName, value);
        ...
        internal double? GetMemberNullableNumber(string memberName) => _jsNativeLib.GetMemberNullableNumber(Uuid, memberName);
        ...
        internal void SetMemberNullableNumber(string memberName, double? value) => _jsNativeLib.SetMemberNullableNumber(Uuid, memberName, value);
        ...
        internal bool GetMemberBoolean(string memberName) => _jsNativeLib.GetMemberBoolean(Uuid, memberName);
        ...
        internal void SetMemberBoolean(string memberName, bool value) => _jsNativeLib.SetMemberBoolean(Uuid, memberName, value);
        ...
        internal string GetMemberReference(string memberName) => _jsNativeLib.GetMemberReference(Uuid, memberName);
        ...
        internal void SetMemberReference(string memberName, JsNative value) => _jsNativeLib.SetMemberReference(Uuid, memberName, value?.Uuid);
    }
}
